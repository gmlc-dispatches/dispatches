...
from dispatches.prescient_sweeps.prescient_options_15_reserves_500_shortfall import prescient_options
from dispatches.prescient_sweeps.utils import run_sweep

bad_guys = [1065, 1078, 1091, 1104, 1117, 1130, 1143, 1156, 1169]
