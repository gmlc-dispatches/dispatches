...
for base_dir in base_directories:
    ...
    multiprocessing.Process(target=summarize_results, args=(base_dir, index_mapper, generator_name, bus_name, output_dir, battery_name+"_charge", battery_name+"_discharge")).start()
