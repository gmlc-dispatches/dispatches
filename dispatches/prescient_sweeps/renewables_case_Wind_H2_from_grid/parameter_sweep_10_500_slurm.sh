...
## to run:
## sbatch --array=0-15 parameter_sweep_10_500_slurm.sh
...
python parameter_sweep_10_500.py $((SLURM_ARRAY_TASK_ID*JOBS_PER_NODE)) $(((SLURM_ARRAY_TASK_ID+1)*JOBS_PER_NODE))
