...
# This code does not filter capacity factor = 0/1 days. 
...
class TSA64K:
    ...
    def read_data(self):
        ...
        # print(self.index)
        # transfer the data to the np.array, dimension of self.year*8736(total dispatch hours in one year)
    ...
    def read_input_pmax(self):
        ...
        input_data = '..\\datasets\\prescient_generator_inputs.h5'
...
def main():
    ...
    for i in range(10):
        this_file_path = os.getcwd()
        dispatch_data = f'..\\datasets\\Dispatch_data_shuffled_{i}.csv'
