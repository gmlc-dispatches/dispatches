...
def main():
    ...
    # dispatch_data_path = '../../../../../datasets/results_renewable_sweep_Wind_H2_new/Dispatch_data_RE_H2_whole.csv'
    ...
    dispatch_data_path = '../../../../../datasets/results_fossil_sweep/Dispatch_data_FE_Dispatch_whole.csv'
    ...
    # model_type = 'revenue'
    # data_path = '../../../../../datasets/results_fossil_sweep/FE_revenue.csv'
    # NNtrainer_rev = TrainNNSurrogates(simulation_data, model_type, data_path, filter_opt)
    ...
    NNtrainer_df = TrainNNSurrogates(simulation_data, model_type, clustering_model_path, filter_opt = True)
