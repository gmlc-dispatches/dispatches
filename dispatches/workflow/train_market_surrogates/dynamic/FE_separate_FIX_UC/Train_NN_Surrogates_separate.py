...
class TrainNNSurrogates:
    ...
    def __init__(self, simulation_data_gen, simulation_data_storage, data_file, filter_opt = True):
    ...
    def _transform_dict_to_array(self):
        ...
        index_list = list(self.simulation_data_gen._dispatch_dict.keys())
        ...
        for idx in index_list:
            x.append(self.simulation_data_gen._input_data_dict[idx])
            y.append(y_dict[idx])
