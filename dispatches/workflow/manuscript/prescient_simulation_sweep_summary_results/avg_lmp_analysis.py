...
# df3 = pd.read_hdf("_dataframes/prescient_generator_startups.h5")
# df4 = pd.read_hdf("_dataframes/prescient_generator_zones.h5")
...
#CASE 1: low pmax
#pmax,pmin_multi,ramp_multi,min_up_time,min_dn_multi,no_load_cst,startup_cst
cases1 = []
surrogate_data1 = []
pmax = 177.5
for i in range(5):
