...
from pyomo.environ import Var, units as pyunits, exp, log
...
class CO2CaptureData(UnitModelBlockData):
    ...
    def add_material_balances(self):
        ...
        def SRD_eqn(b, t):
            x1 = b.lean_loading[t]
            x2 = b.Pz_mol[t]
            # return b.SRD[t] == (1135585.36238969 * x1
            #                     - 440.509698856962 * log(x1)
            #                     - 1127184.48012032 * exp(x1)
            #                     + 533953.122356288 * x1**2
            #                     + 248202.546339126 * x1**3
            #                     + 1125580.12992624)
