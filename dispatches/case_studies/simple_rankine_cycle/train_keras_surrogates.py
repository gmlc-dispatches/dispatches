...
"""
Train a surrogate model for the number of strartups
"""
# Load prescient data
...
# Construct Keras surrogate models for nstartups
...
# Construct a keras surrogate models for revenue
train_surrogate_model(
    x_data=X_train,
    z_data=z_train,
    trainer="keras",
...
# Construct a keras surrogate models for zones
train_surrogate_model(
    x_data=X_train,
    z_data=z_train,
    trainer="keras",
