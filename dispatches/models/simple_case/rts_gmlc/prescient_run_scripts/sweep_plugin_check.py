...
startup_cost_data = { 'yellow' : [ (0.75, 94.00023429), (2.5, 135.2230393), (3, 147.0001888) ], #sometimes duplicates are removed. duplicate removes middle entry.
  ...
  #we also simulated: [(1.0,0.0)]

  #surrogate with free cost
  [(0.11110000098605034,1.993745486385813e-06,),(2.499999953312715,25.19232276373661,),(5.000000240637918,147.0)]
