...
scaled_dispatch = (dispatch_on - pmin) / (pmax - pmin) * 100
...
columns = list(zip(labels,list(prescient_zone_hours),list(dispatch_zones)))
...
ax.tick_params(axis='x', labelrotation = 45)
plt.tight_layout()
plt.savefig(result_data_dir+"zone_operation_surrogate_yellow_175.png")
