...
with open("alamo_surrogates/revenue_scaled_cutoff_0_5_terms_model_2.pkl", "rb") as input_file:
...
with open("alamo_surrogates/revenue_scaled_cutoff_0_all_terms_model_1.pkl", "rb") as input_file:
    model_data = pickle.load(input_file)
