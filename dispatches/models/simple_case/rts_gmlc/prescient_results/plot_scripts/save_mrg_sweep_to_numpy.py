...
result_dir = 'sensitivity_sweep_over_mrg_cst_0/price_results'
os.makedirs(result_dir, exist_ok=True)
for index in range(0,6):
    result_data_dir = 'sensitivity_sweep_over_mrg_cst_0/deterministic_simulation_output_index_{}'.format(index)
    ...
    with open(result_dir+'/mrg_cst_sweep_{}.npy'.format(index), 'wb') as f:
        np.save(f,dispatch)
        np.save(f,lmp)
