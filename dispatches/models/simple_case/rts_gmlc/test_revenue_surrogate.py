...
m.revenue = Expression(rule = revenue_rule)
...
# ramp_rate = (200.0 - xm[2])/xstd[2]
# min_up_time = (3 - xm[3])/xstd[3]
# min_down_time = (5  - xm[4])/xstd[4]
# marg_cst = (15 - xm[5])/xstd[5]
# no_load_cst = (0 - xm[6])/xstd[6]
# st_time_hot = (0.4 - xm[7])/xstd[7]
# st_time_warm = (1.0 - xm[8])/xstd[8]
# st_time_cold = (3 - xm[9])/xstd[9]
# st_cst_hot = (30.0 - xm[10])/xstd[10]
# st_cst_warm = (60.0 - xm[11])/xstd[11]
# st_cst_cold = (100.0 - xm[12])/xstd[12]

# x = [200,0,ramp_rate,min_up_time,min_down_time,marginal_cost,no_load_cost,start_time_hot,start_time_warm,start_time_cold,start_cost_hot,start_cost_warm,start_cost_cold]
