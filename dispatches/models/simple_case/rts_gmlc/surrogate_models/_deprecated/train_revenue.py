...
alamopy_writer.write_alamo_func(result['model']['revenue'],result['xlabels'],'models/alamo_revenue')
model = result['f(model)']['revenue']
...
with open('alamo_revenue.pkl', "wb") as output_file:
